...
class LambdaService:
    ...
    @classmethod
    async def invoke_function(cls, function_name: str, payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    def _invoke_function_sync(self, function_name: str, payload: Dict[str, Any]) -> Dict[str, Any]:
