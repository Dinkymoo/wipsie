...
def lambda_handler(event, context):
    ...
    try:
        ...
        if api_base_url != 'http://localhost:8000':  # Only call API if not local dev
...
def store_data_via_api(api_base_url: str, data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        ...
        response = requests.post(
            ...
            json=data_points[0] if data_points else {'name': 'empty', 'value': '{}', 'source': 'lambda_poller'},
