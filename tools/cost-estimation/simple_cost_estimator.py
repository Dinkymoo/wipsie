...
def print_cost_estimate(environment: str) -> None:
    ...
    if environment == "learning":
        print("\n💡 Learning Tips:")
        print("   • Perfect for educational use - $0/month!")
        print("   • AWS Free Tier covers all services for 12 months")
        print("   • Use public GitHub repo (unlimited Actions)")
        print("   • Stop RDS when not actively coding")
